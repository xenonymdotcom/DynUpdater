...
private:
	...
	static bool registerApplicationWindowsClass(HINSTANCE hThisInstance)
	{
		...
		winclz.hIcon = LoadIcon (GetModuleHandle(NULL), MAKEINTRESOURCE(IDI_DYNUPDATER));
		winclz.hIconSm = LoadIcon (GetModuleHandle(NULL), MAKEINTRESOURCE(IDI_DYNUPDATER));
